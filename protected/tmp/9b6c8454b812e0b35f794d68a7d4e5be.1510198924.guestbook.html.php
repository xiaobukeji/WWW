            ...
            <div class="col-md-8">
                ...
                <nav>
                    <ul class="pagination pull-right">
                        <li>
                            <a href="<?php echo url(array('c'=>"main", 'a'=>"index", 'p'=>$pager['prev_page'], ));?>" aria-label="Previous">
                        ...
                        <li<?php if ($p == $pager['current_page']) : ?> class="active"<?php endif; ?>>
                            <a href="<?php echo url(array('c'=>"main", 'a'=>"index", 'p'=>$p, ));?>"><?php echo htmlspecialchars($p, ENT_QUOTES, "UTF-8"); ?></a>
                        </li>
                        <?php endforeach; ?>
                        <li>
                            <a href="<?php echo url(array('c'=>"main", 'a'=>"index", 'p'=>$pager['next_page'], ));?>" aria-label="Next">
